...
const fieldDescriptions = {
  ...
  'advantages.willpower': 'O preenchimento mostra a Força de Vontade temporária. Durante a edição, cliques sucessivos preenchem, removem o preenchimento e removem a borda permanente, devolvendo o ponto gasto.',
...
const characterListsFile = 'listas.json';
...
const defaultGithubRepo = 'jogatina-pesada/mage-ascension';
const defaultGithubBranch = 'main';
const defaultGithubSheetsPath = 'fichas';
...
let selectedCharacterList = 'default';
let pendingCharacterList = null;
let pendingListPasswordReset = null;
