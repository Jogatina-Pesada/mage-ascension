...
const wikiTopics = [
  {
    ...
    entries: [
      ...
      ['Impressão', 'O botão de impressão gera uma ficha em alto contraste. Nome, Crônica, Atributos, Habilidades, Esferas e Arcana saem preenchidos; os demais campos da ficha principal permanecem em branco. Coven e Linhagem não são impressos. Ao final, uma página adicional reúne, preenchidas, as abas Antecedentes e Quem você é no mundo. A janela do navegador permite imprimir em papel ou salvar a ficha em PDF.'],
  ...
  },
  {
    ...
    entries: [
      ...
      ['Despensa', 'Inventário compartilhado com 16 espaços, nomes, descrições e imagens. Um item também pode ser importado pelo ID do inventário geral: nome, descrição e todas as imagens são copiados para o coven, preservando o ID de origem, mas efeitos de Esfera não são armazenados no coven. Depois da cópia, alterações no inventário e na Despensa são independentes. Itens podem ser excluídos durante a edição após confirmação.'],
      ['Usar item do inventário', 'Um item da Despensa com ID de inventário pode ser usado uma única vez. Antes da confirmação, um resumo mostra todos os efeitos relidos do inventário. Cada Esfera que atender ao próprio nível mínimo recebe os pontos sem ultrapassar o máximo configurado; efeitos sem o requisito são ignorados sem bloquear os demais. Ao confirmar, o item é marcado como usado. O modal de detalhes informa esse estado mesmo no modo somente leitura.'],
      ['Salvamento da Despensa', 'Criar, alterar, excluir ou consumir um item salva automaticamente o coven sem liberar o lock. A edição continua disponível até ser concluída ou atingir o limite de dez minutos.'],
      ['Edição', 'A edição sincronizada usa um bloqueio temporário de até dez minutos por sessão do navegador. Recarregar a mesma aba preserva a sessão; outra aba, mesmo do mesmo usuário, não pode substituir um lock ativo. Se o autosave da ficha ainda não estiver ativo, a ficha solicita usuário GitHub e PAT apenas para sincronizar o coven. Enquanto houver um lock ativo, a seção informa quem está editando e até quando.']
    ]
  },
  {
    id: 'lineage',
