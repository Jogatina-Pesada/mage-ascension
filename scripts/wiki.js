...
const wikiTopics = [
  {
    ...
    entries: [
      ...
      ['Impressão', 'O botão de impressão gera uma ficha em branco de alto contraste, preservando apenas a foto da personagem. Campos, níveis, recursos e estados preenchidos na tela não aparecem na impressão. As linhas de bolinhas permanecem vazias e alinhadas horizontalmente. A janela do navegador permite imprimir em papel ou salvar a ficha em PDF.'],
