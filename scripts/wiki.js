...
const wikiTopics = [
  ...
  },
  {
    ...
    entries: [
      ...
      ['Edição', 'A edição sincronizada usa um bloqueio temporário de até dez minutos. Se o autosave da ficha ainda não estiver ativo, a ficha solicita usuário GitHub e PAT apenas para sincronizar o coven. Enquanto houver um lock ativo, a seção informa quem está editando e até quando.']
    ]
  },
  {
    id: 'lineage',
