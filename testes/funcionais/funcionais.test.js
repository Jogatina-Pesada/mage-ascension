...
test('upload permite escolher default ou informar uma nova lista protegida', async () => withApp(async (win, doc) => {
  ...
  assert.equal(doc.getElementById('githubCharacterList').value, '');
  assert.equal(doc.getElementById('githubCharacterList').options[0].textContent, 'selecione uma lista');
